...
public class WeightLoss extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            cardList = SuggestionFetcher.fetch(this ,getAssets().open("weightLoss"));
        } catch (IOException e) {
            //todo: remove below line
            Toast.makeText(this , "Weight loss: Somebody has messed with the app folder. The file containing suggestions has gone missing" , Toast.LENGTH_LONG).show();
            return;
        }
