...
public class LegExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_leg_excercise);
        ...
        try {
            cardList = SuggestionFetcher.fetch(this ,getAssets().open("legExercise.txt"));
        } catch (IOException e) {
